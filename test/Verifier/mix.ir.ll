...
define i8* @constexpr0(i8* %x) {
  ; CHECK: First argument of llvm.mix.ir is not a constant expression
  ; CHECK: %f = call {{.*}}
  %f = call i8* (i8*, i8*, ...) @llvm.mix.ir(i8* %x, i8* null)
  ret i8* %f
}
...
define i8* @constexpr1() {
  ; CHECK: First argument of llvm.mix.ir is not a constant expression
  ; CHECK: %f = call {{.*}}
  %f = call i8* (i8*, i8*, ...) @llvm.mix.ir(i8* null, i8* null)
  ret i8* %f
}

define i8* @notid() {
  ; CHECK: First argument of llvm.mix.ir is not a function identifier
  ; CHECK: %f = call {{.*}}
  %f = call i8* (i8*, i8*, ...) @llvm.mix.ir(i8* bitcast (i32* inttoptr (i32 4 to i32*) to i8*), i8* null)
  ret i8* %f
}
...
define i8* @argcount0() {
  ...
  ; CHECK: %f = call {{.*}}
  %f = call i8* (i8*, i8*, ...) @llvm.mix.ir(i8* bitcast (void (i32)* @f to i8*), i8* null)
  ret i8* %f
}
...
define i8* @argcount1() {
  ...
  ; CHECK: %f = call {{.*}}
  %f = call i8* (i8*, i8*, ...) @llvm.mix.ir(i8* bitcast (void (i32)* @f to i8*), i8* null, i32 1, i32 1)
  ret i8* %f
}
...
define i8* @argcount2() {
  ...
  ; CHECK: %h = call {{.*}}
  %h = call i8* (i8*, i8*, ...) @llvm.mix.ir(i8* bitcast (void (i32, ...)* @h to i8*), i8* null)
  ret i8* %h
}

define i8* @argcount3() {
  %h = call i8* (i8*, i8*, ...) @llvm.mix.ir(i8* bitcast (void (i32, ...)* @h to i8*), i8* null, i32 1, i32 1)
  ret i8* %h
}
...
define i8* @argtypes0() {
  ...
  ; CHECK: %j = call {{.*}}
  %j = call i8* (i8*, i8*, ...) @llvm.mix.ir(i8* bitcast (void (i32, i32)* @j to i8*), i8* null, i16 1, i32 1)
  ret i8* %j
}
...
define i8* @argtypes1() {
  ...
  ; CHECK: %j = call {{.*}}
  %j = call i8* (i8*, i8*, ...) @llvm.mix.ir(i8* bitcast (void (i32, i32)* @j to i8*), i8* null, i32 1, i16 1)
  ret i8* %j
}
