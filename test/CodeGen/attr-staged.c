...
int staged(struct { int x, y; } __attribute__((staged)) * s) __stage(1) {
  ...
  // CHECK-NEXT: call void @llvm.object.stage.p0i32(i32* [[x]], i32 0)
  // CHECK: [[y:%.+]] = getelementptr {{.*}}, i32 1
  // CHECK-NEXT: call void @llvm.object.stage.p0i32(i32* [[y]], i32 0)
  return s->x + s->y;
}
...
int staged1(struct { int x, y __stage(1); } __attribute__((staged)) * s) __stage(1) {
  ...
  // CHECK-NEXT: call void @llvm.object.stage.p0i32(i32* [[x]], i32 0)
  // CHECK: [[y:%.+]] = getelementptr {{.*}}, i32 1
  // CHECK-NEXT: call void @llvm.object.stage.p0i32(i32* [[y]], i32 1)
  return s->x + s->y;
}
