...
__stage(1) int subject0; // expected-warning {{only applies to functions and parameters}}
int __stage(1) subject1; // expected-warning {{only applies to functions and parameters}}
